...
To verify the results of the embedding trading strategies shown: request access from myself (cbassmagana @ gmail.com) for the Pinecone API Key, and then run strategies with the command 'python EmbeddingStrategy{x}.py'.
